import "./demo_cv.css";
import pic from "../../images/employee.png"
const DemoCV = () => {
    return (
        <div className="Home">
            <div className="CVrow">
                ...
                <div className="column2">
                    <table className="tableContent">
                        <tr>
                            <td>
                                <div className="nameCss">Full Name</div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                ...
                                <br></br>
                                <hr></hr>
                                <b className="CompanyName">Full Stack Developer, Apple,</b> <div className="DateRange">(July 2022 - present)</div>
                                <p className="data">
                                    <ul>
                                ...
                                <b className="CompanyName">Consultant, Softtech India, </b> <div className="DateRange"> (Aug 2016 - April 2020)</div>
                                <p className="data">
                                    <ul>
                                ...
                                <b className="CompanyName">Software Developer, Abc infotech Pvt Ltd,</b> <div className="DateRange"> (Aug 2014 - Aug 2016)</div>
                                <p className="data">
                                    <ul>
                                        <li>Worked on front-end UI development using Asp.net, HTML, CSS, JavaScript, and jQuery</li>
                                        <li>Developed and maintained back-end systems using C# and SQL Server</li>
