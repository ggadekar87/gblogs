import "./GaneshCV.css";
import pic from "../../../images/USA_PIC.jpg"
const GaneshCV = () => {
    return (
        <div className="Home">
            <div className="CVrow">
                ...
                <div className="column2">
                    <table className="tableContent">
                        <tr>
                            <td>
                                <div className="nameCss">Ganesh Gadekar (H1B VISA)</div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                ...
                                <br></br>
                                <hr></hr>
                                <b className="CompanyName">Full Stack Developer, Param Info, UAE,</b> <div className="DateRange">(July 2022 - present)</div>
                                <p className="data">
                                    <ul>
                                ...
                                <b className="CompanyName">Consultant, Allstate India, and Belfast UK, </b> <div className="DateRange"> (Aug 2016 - April 2020)</div>
                                <p className="data">
                                    <ul>
                                ...
                                <b className="CompanyName">Software Developer, Open destinations Goa,</b> <div className="DateRange"> (Aug 2014 - Aug 2016)</div>
                                <p className="data">
                                    <ul>
                                        <li>Worked on front-end UI development using Asp.net, HTML, CSS, JavaScript, and jQuery</li>
                                        <li>Developed and maintained back-end systems using C# and SQL Server</li>
                                    ...
                                    <b className="CompanyName">Software Developer, Davzon Pvt Ltd, India,</b> <div className="DateRange"> (May 2013 – July 2014)</div>
                                <p className="data">
                                    <ul>
                                        <li>Worked on front-end UI development using Asp.net, HTML, CSS, JavaScript, and jQuery</li>
                                        <li>Developed and maintained back-end systems using C# and SQL Server</li>
